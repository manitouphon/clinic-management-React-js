...
//Main Export: --------------------------------------------------------------------------------------------
export default function AddStaffDialog({ open, setOpen, setdata, staffType, dbUrl }) {
  ...
  const handleSubmit = (e) => {
    ...
    const DisplayCurrentTime= showDate.getHours()+' : '+showDate.getMinutes()+' : '+showDate.getSeconds();
