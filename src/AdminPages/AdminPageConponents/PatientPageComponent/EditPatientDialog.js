...
export default function EditPatientDialog({ open, setOpen, setdata, doctor }) {
  ...
  useEffect(() => {
    ...
    setlast_name(doctor.last_name);
    setSex(doctor.sex);
    setblood_Group(doctor.blood_Group);
    setAge(doctor.age);
    setRemark(doctor.remark);
    setPhone(doctor.phone);
    setEmail(doctor.email);
    setPlace_Of_Birth(doctor.place_of_birth);
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      fetch("http://localhost:8000/Patient/" + doctor.id, {
        method: "PUT",
        mode: "cors",
        body: JSON.stringify({
          first_name,
