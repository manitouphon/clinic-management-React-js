import {
  ...
  import AddDoctorDialog from "../AdminPageConponents/AddDoctorDialog";
  import { Fetch_data } from "../../API/Fetch_data";
  import ComfirmDeleteDialog from "../AdminPageConponents/ComfirmDeleteDialog";
  import Notification from "../AdminPageConponents/Notification";
  import EditDailog from "../AdminPageConponents/EditDailog";
  import RateReviewIcon from '@material-ui/icons/RateReview';
  import ViewDoctor from "./ViewPharmacist";
  ...
  function PharmacistListTable({ open, setOpen }) {
    ...
    const pharmacist = Fetch_data("http://localhost:8000/Pharmacist");
    ...
    return (
      <>
        <TableContainer>
          <Table className={classes.table} aria-label="Pharmacist-table" stickyHeader>
            <TableHead>
              <TableRow>
        ...
        <EditDailog open={openForEdit} setOpen={setOpenForEdit} setdata={pharmacist.setdata}/>
        <AddDoctorDialog open={open} setOpen={setOpen} setdata={pharmacist.setdata} />
        <ViewDoctor open={openForView} setOpen={setOpenForView}/>
      </>
    );
  }
  
  export default PharmacistListTable;
